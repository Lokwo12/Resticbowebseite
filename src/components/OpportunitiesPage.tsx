    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-800 text-white pt-32 sm:pt-40 pb-12 sm:pb-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-[32px] sm:text-[36px] lg:text-[48px] font-bold sm:font-extrabold font-heading mb-4 text-white leading-[1.1]">Open Opportunities</h1>
          ...
          {displayOpportunities.map((opportunity) => (
            <div key={opportunity.id} className="bg-white rounded-2xl shadow-xl p-6 md:p-8 border border-gray-100 flex flex-col md:flex-row md:items-center justify-between gap-6 hover:shadow-2xl transition-shadow duration-300">
              ...
              <div className="flex-shrink-0">
                <Link to="/contact" className="inline-flex items-center justify-center bg-emerald-50 hover:bg-emerald-100 text-emerald-700 font-medium py-3 px-6 rounded-xl transition-colors gap-2 w-full md:w-auto">
